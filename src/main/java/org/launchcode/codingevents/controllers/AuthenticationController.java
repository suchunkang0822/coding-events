...
public class AuthenticationController {
    ...
    // HttpSession handles the details of session creation and
    // lookup for us, including generating unique session IDs
    // and session cookies.
    ...
    @GetMapping("/register")
    public String displayRegistartionForm(Model model){
